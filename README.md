...
- `interventions/`: Informational interventions used in the study. We include the letters submitted to study participants assigned to five experimental groups that targets the following frictions: awareness about refinancing, beliefs about gains from refinancing, switching costs, and search costs. Each of the first four interventions targets these frictions individually, whereas the full intervention targets all of them jointly. 
